...
class SystemSimulationClock implements SimulationClock {
...
class ManualSimulationClock implements SimulationClock {
  int _nowMs;

  /// Creates a manual clock starting at [nowMs].
  ManualSimulationClock([int nowMs = 0]) : _nowMs = nowMs;
